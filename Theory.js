  ...
  * 
  * JavaScript (or "JS") is a programming language used most often for 
  * dynamic client-side scripts on webpages,but it is also often used on the server-side,
  ...
  *
    ...
    collection of similar iteams

     What is rest opreator in javascript?
...
OPreators ---> Javascript operators are used to perform different 
